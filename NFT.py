...
def main():
    ...
    if choice == '1':
        ...
        link = input("Entrez le lien pour créer un NFT: ")
        from_address = input("Entrez votre adresse pour créer le NFT: ")
        create_nft(link, from_address)
    else:
